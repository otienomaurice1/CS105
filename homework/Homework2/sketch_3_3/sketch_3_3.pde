 ...
 //Description: this sketch drws zoog and makes its legs thicker when the mouse is moved faster
 // additional info: this is homework for witch i was given extension
 
 float mousespeed = abs(mouseX-pmouseX); // declare the variable mouse speed and initialize it with the the result of the computation 
 void setup(){
